...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 12 2018 г., 18:38
...
--
-- Структура таблицы `albums_cat`
--

CREATE TABLE IF NOT EXISTS `albums_cat` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
...
--
-- Структура таблицы `albums_comm`
--

CREATE TABLE IF NOT EXISTS `albums_comm` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `albums_photos`
--
...
--
-- Структура таблицы `albums_rating`
--

CREATE TABLE IF NOT EXISTS `albums_rating` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `photo_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bann` (
  ...
  `time_bann` int(11) NOT NULL,
  `prich` varchar(250) NOT NULL,
  `time` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `blackusers`
--

CREATE TABLE IF NOT EXISTS `blackusers` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `chat_msg` (
  ...
  `user_id` int(11) NOT NULL,
  `kont_id` int(11) NOT NULL,
  `privat` int(1) NOT NULL,
  `time` int(11) NOT NULL,
  `msg` text NOT NULL,
  `umnik_st` int(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `chat_vopros` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `config` (
  `default_lng` varchar(20) NOT NULL DEFAULT 'ru',
  `write_room` int(2) NOT NULL,
  `write_news` int(2) NOT NULL,
  `write_news_comm` int(2) NOT NULL,
  `write_guestbook` int(2) NOT NULL,
  `max_upload_photo` int(2) NOT NULL,
  `max_upload_guestbook` int(2) NOT NULL,
  `photo_par_x` int(4) NOT NULL,
  `photo_par_y` int(4) NOT NULL,
  `mini_photo_par_x` int(4) NOT NULL,
  `mini_photo_par_y` int(4) NOT NULL,
  `bot_umnik` int(11) NOT NULL,
  `write_forum_post` int(2) DEFAULT NULL,
  `write_forum_theme` int(2) DEFAULT NULL,
  `write_forum_razd` int(2) DEFAULT NULL,
  `write_blog` int(2) DEFAULT NULL,
  `write_blog_comm` int(2) DEFAULT NULL,
  `write_blog_comm_view` int(2) DEFAULT NULL,
  `write_group` int(2) DEFAULT NULL,
  `write_group_topic` int(2) DEFAULT NULL,
  `write_group_msg` int(2) DEFAULT NULL,
  `write_lib_cat` int(10) DEFAULT NULL,
  `write_lib_pod_cat` int(10) DEFAULT NULL,
  `write_lib_simvol` int(10) DEFAULT NULL,
  `write_lib_comm` int(10) DEFAULT NULL,
  `write_load_cat` int(10) DEFAULT NULL,
  `write_load_files` int(10) DEFAULT NULL,
  `write_load_comm` int(10) DEFAULT NULL,
  `reg_msg` text,
  `reg_present` int(11) DEFAULT NULL,
...
INSERT INTO `config` (`default_lng`, `write_room`, `write_news`, `write_news_comm`, `write_guestbook`, `max_upload_photo`, `max_upload_guestbook`, `photo_par_x`, `photo_par_y`, `mini_photo_par_x`, `mini_photo_par_y`, `bot_umnik`, `write_forum_post`, `write_forum_theme`, `write_forum_razd`, `write_blog`, `write_blog_comm`, `write_blog_comm_view`, `write_group`, `write_group_topic`, `write_group_msg`, `write_lib_cat`, `write_lib_pod_cat`, `write_lib_simvol`, `write_lib_comm`, `write_load_cat`, `write_load_files`, `write_load_comm`, `reg_msg`, `reg_present`, `reg_user`) VALUES
('ru', 30, 5, 5, 20, 0, 10, 0, 0, 0, 0, 0, 10, 10, 20, 5, 5, 3, 10, 5, 5, 20, NULL, 5000, 15, 15, 10, 10, 'Добро пожаловать на сайт! :)', 10, 1);
...
--
-- Структура таблицы `dey`
--

CREATE TABLE IF NOT EXISTS `dey` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dialog_msg` (
  ...
  `delet` varchar(110) NOT NULL,
  `spam` varchar(5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `files_comm`
--

CREATE TABLE IF NOT EXISTS `files_comm` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `forums_new_post`
--

CREATE TABLE IF NOT EXISTS `forums_new_post` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `forums_post`
--

CREATE TABLE IF NOT EXISTS `forums_post` (
  `id` int(11) NOT NULL,
  `forum_id` int(11) NOT NULL,
  `forumc_id` int(11) NOT NULL,
  `theme_id` varchar(100) NOT NULL,
  `msg` text,
  `user_id` int(11) NOT NULL,
  `time` int(11) NOT NULL,
...
--
-- Структура таблицы `forums_theme`
--

CREATE TABLE IF NOT EXISTS `forums_theme` (
  `id` int(11) NOT NULL,
  `forum_id` int(11) NOT NULL,
  `forumc_id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  ...
  `vote_1` varchar(100) NOT NULL,
  `vote_2` varchar(100) NOT NULL,
  `vote_3` varchar(100) NOT NULL,
  `vote_4` varchar(100) NOT NULL,
  `vote_5` varchar(100) NOT NULL,
  `vote_6` varchar(100) NOT NULL,
  `vote_7` varchar(100) NOT NULL,
  `vote_8` varchar(100) NOT NULL,
  `vote_9` varchar(100) NOT NULL,
  `vote_10` varchar(100) NOT NULL,
  `uvedom` int(1) NOT NULL,
  `user_id` int(11) DEFAULT NULL,
  `time` int(11) DEFAULT NULL,
  `status` int(1) DEFAULT NULL,
  `activ` int(11) DEFAULT NULL,
  `fix` int(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Структура таблицы `forums_vote`
--

CREATE TABLE IF NOT EXISTS `forums_vote` (
  `id` int(11) NOT NULL,
  `theme_id` varchar(100) NOT NULL,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `groups` (
  ...
  `time` int(11) DEFAULT NULL,
  `private_forum` int(1) DEFAULT NULL,
...
--
-- Структура таблицы `groups_apps`
--

CREATE TABLE IF NOT EXISTS `groups_apps` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `groups_new_post`
--

CREATE TABLE IF NOT EXISTS `groups_new_post` (
  `id` int(11) NOT NULL,
  `theme_id` varchar(100) NOT NULL,
  `user_id` int(11) NOT NULL,
  `status` int(11) NOT NULL
...
--
-- Структура таблицы `groups_peoples`
--

CREATE TABLE IF NOT EXISTS `groups_peoples` (
  `id` int(11) NOT NULL,
  `group_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Структура таблицы `groups_post`
--

CREATE TABLE IF NOT EXISTS `groups_post` (
  `id` int(11) NOT NULL,
  `group_id` int(11) NOT NULL,
...
--
-- Структура таблицы `groups_topic`
--

CREATE TABLE IF NOT EXISTS `groups_topic` (
  `id` int(11) NOT NULL,
  `group_id` int(11) NOT NULL,
  ...
  `vote_1` varchar(100) DEFAULT NULL,
  `vote_2` varchar(100) DEFAULT NULL,
  `vote_3` varchar(100) DEFAULT NULL,
  `vote_4` varchar(100) DEFAULT NULL,
  `vote_5` varchar(100) DEFAULT NULL,
  `vote_6` varchar(100) DEFAULT NULL,
  `vote_7` varchar(100) DEFAULT NULL,
  `vote_8` varchar(100) DEFAULT NULL,
  `vote_9` varchar(100) DEFAULT NULL,
  `vote_10` varchar(100) DEFAULT NULL,
  `uvedom` int(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Структура таблицы `groups_vote`
--
...
CREATE TABLE IF NOT EXISTS `guest` (
  ...
  `vote_1` varchar(250) NOT NULL,
  `vote_2` varchar(250) NOT NULL,
  `vote_3` varchar(250) NOT NULL,
  `vote_4` varchar(250) NOT NULL,
  `vote_5` varchar(250) NOT NULL,
  `vote_6` varchar(250) NOT NULL,
  `vote_7` varchar(250) NOT NULL,
  `vote_8` varchar(250) NOT NULL,
  `vote_9` varchar(250) NOT NULL,
  `vote_10` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `guest_comments`
--
...
--
-- Структура таблицы `guest_like`
--

CREATE TABLE IF NOT EXISTS `guest_like` (
  `id` int(11) NOT NULL,
  `post_id` int(11) NOT NULL DEFAULT '0',
  `user_id` int(11) NOT NULL DEFAULT '0',
  `time` int(11) NOT NULL
...
--
-- Структура таблицы `lib_articl`
--

CREATE TABLE IF NOT EXISTS `lib_articl` (
  `id` int(11) NOT NULL,
  `folder_id` int(11) NOT NULL,
  `folderc_id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
  `text` text NOT NULL,
  `info` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `lib_cat` (
  `id` int(11) NOT NULL,
  `folder_id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `loads_cat`
--

CREATE TABLE IF NOT EXISTS `loads_cat` (
  `id` int(11) NOT NULL,
  `folder_id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  `icon` varchar(100) DEFAULT NULL
...
--
-- Структура таблицы `loads_comm`
--

CREATE TABLE IF NOT EXISTS `loads_comm` (
  `id` int(11) NOT NULL,
  `file_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `comm` text NOT NULL,
...
--
-- Структура таблицы `loads_file`
--

CREATE TABLE IF NOT EXISTS `loads_file` (
  `id` int(11) NOT NULL,
  `folder_id` int(11) NOT NULL,
  `folderc_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Структура таблицы `loads_file_dop`
--

CREATE TABLE IF NOT EXISTS `loads_file_dop` (
  `id` int(11) NOT NULL,
  `folder_id` int(11) NOT NULL,
  `folderc_id` int(11) NOT NULL,
  `file_id` int(11) NOT NULL,
...
--
-- Структура таблицы `loads_rating`
--

CREATE TABLE IF NOT EXISTS `loads_rating` (
  `id` int(11) NOT NULL,
  `file_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `type` varchar(20) NOT NULL
...
--
-- Структура таблицы `loads_screen`
--

CREATE TABLE IF NOT EXISTS `loads_screen` (
  `id` int(11) NOT NULL,
  `file_id` int(11) NOT NULL,
  `url` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `photo_comm`
--

CREATE TABLE IF NOT EXISTS `photo_comm` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `friend_id` int(11) NOT NULL,
  `comm` text NOT NULL,
...
--
-- Структура таблицы `photo_rating`
--
...
INSERT INTO `positions` (`id`, `position`, `prioritet`) VALUES
(1, 'Moderator', 1420383652),
(2, 'Admin o`rinbosari', 1420383665),
(3, 'Adminstrator', 1420383672),
(4, 'Sayt yaratuvchisi', 1420383674);
...
INSERT INTO `presents` (`id`, `url`) VALUES
(1, '1.png'),
(2, '2.png'),
(3, '3.png'),
(4, '4.png'),
...
--
-- Структура таблицы `presents_list`
--

CREATE TABLE IF NOT EXISTS `presents_list` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `presents_list`
--

INSERT INTO `presents_list` (`id`, `present_id`, `user_id`, `friend_id`, `anonim`, `time`, `comm`) VALUES
(1, 10, 1, 2, 0, 1518034756, 'Добро пожаловать, на наш сайт!'),
(2, 10, 1, 3, 0, 1518036358, 'Добро пожаловать, на наш сайт!'),
(3, 10, 1, 4, 0, 1518208043, 'Добро пожаловать, на наш сайт!'),
(4, 10, 1, 5, 0, 1518260196, 'Добро пожаловать, на наш сайт!'),
(5, 10, 1, 6, 0, 1518429442, 'Добро пожаловать, на наш сайт!'),
(6, 10, 1, 7, 0, 1518430905, 'Добро пожаловать, на наш сайт!'),
(7, 10, 1, 8, 0, 1518431956, 'Добро пожаловать, на наш сайт!'),
(8, 10, 1, 9, 0, 1518433302, 'Добро пожаловать, на наш сайт!'),
(9, 10, 1, 10, 0, 1518433519, 'Добро пожаловать, на наш сайт!'),
(10, 10, 1, 11, 0, 1518433545, 'Saytimizga xush kelibsiz!'),
(11, 10, 1, 12, 0, 1518435354, 'Добро пожаловать, на наш сайт!'),
(12, 10, 1, 13, 0, 1518436283, 'Добро пожаловать, на наш сайт!'),
(13, 10, 1, 14, 0, 1518436965, 'Saytimizga xush kelibsiz!'),
(14, 10, 1, 15, 0, 1518439537, 'Добро пожаловать, на наш сайт!'),
(15, 10, 1, 16, 0, 1518440774, 'Добро пожаловать, на наш сайт!'),
(16, 10, 1, 17, 0, 1518443302, 'Добро пожаловать, на наш сайт!'),
(17, 10, 1, 18, 0, 1518444073, 'Добро пожаловать, на наш сайт!');
...
INSERT INTO `privilege` (`id`, `pos`, `privil`) VALUES
(18, 4, 'ipsoft'),
(19, 4, 'anceta_update'),
(20, 4, 'news'),
(21, 4, 'news_comm_delete'),
(22, 4, 'anceta_delete'),
(23, 4, 'anceta_bann'),
(24, 4, 'positions'),
(25, 4, 'level'),
...
--
-- Структура таблицы `status_comm`
--

CREATE TABLE IF NOT EXISTS `status_comm` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Структура таблицы `status_rating`
--

CREATE TABLE IF NOT EXISTS `status_rating` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `status_id` int(11) NOT NULL,
  `rating` int(11) NOT NULL,
...
--
-- Структура таблицы `touch_msg`
--

CREATE TABLE IF NOT EXISTS `touch_msg` (
  `id` int(11) NOT NULL,
  `msg` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `cinema` text,
  `books` text,
  `smok` int(1) DEFAULT NULL,
  `alco` int(1) DEFAULT NULL,
  `narco` int(1) DEFAULT NULL,
  `poznakom` int(1) DEFAULT NULL,
  `age1` int(2) DEFAULT NULL,
  `age2` int(2) DEFAULT NULL,
  `goal` int(1) DEFAULT NULL,
  `family_status` int(1) DEFAULT NULL,
  ...
  `chat_restart` int(2) DEFAULT NULL,
  `m` int(1) DEFAULT NULL,
  `color_nick` varchar(100) DEFAULT NULL,
  `zver` varchar(100) DEFAULT NULL,
  `rating` int(11) DEFAULT NULL,
  `site_version` varchar(15) DEFAULT NULL,
  `guestbook_post` int(11) DEFAULT NULL,
  `victorina` int(11) DEFAULT NULL,
  `chat_post` int(11) DEFAULT NULL,
  ...
  `style` char(100) NOT NULL DEFAULT 'default',
  `private_page` int(1) NOT NULL,
  `private_guest` int(1) NOT NULL,
  `private_usfiles` int(1) NOT NULL,
  `private_photos` int(1) NOT NULL,
  `cover` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Индексы таблицы `albums_cat`
--
ALTER TABLE `albums_cat`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `albums_comm`
--
ALTER TABLE `albums_comm`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `albums_photos`
--
...
--
-- Индексы таблицы `albums_rating`
--
ALTER TABLE `albums_rating`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `bann`
--
ALTER TABLE `bann`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);
...
--
-- Индексы таблицы `blackusers`
--
ALTER TABLE `blackusers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);
...
--
-- Индексы таблицы `dialog_msg`
--
ALTER TABLE `dialog_msg`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);
...
--
-- Индексы таблицы `files_comm`
--
ALTER TABLE `files_comm`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `files_file`
--
...
--
-- Индексы таблицы `forums_cat`
--
ALTER TABLE `forums_cat`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `forums_new_post`
--
ALTER TABLE `forums_new_post`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `forums_post`
--
...
--
-- Индексы таблицы `forums_theme`
--
ALTER TABLE `forums_theme`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `forums_vote`
--
ALTER TABLE `forums_vote`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);
...
--
-- Индексы таблицы `groups_apps`
--
ALTER TABLE `groups_apps`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `groups_new_post`
--
ALTER TABLE `groups_new_post`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `groups_peoples`
--
ALTER TABLE `groups_peoples`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `groups_post`
--
...
--
-- Индексы таблицы `groups_topic`
--
ALTER TABLE `groups_topic`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `groups_vote`
--
ALTER TABLE `groups_vote`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);
...
--
-- Индексы таблицы `guest_comments`
--
ALTER TABLE `guest_comments`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `guest_like`
--
ALTER TABLE `guest_like`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `guest_votes`
--
ALTER TABLE `guest_votes`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `lenta`
--
ALTER TABLE `lenta`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);
...
--
-- Индексы таблицы `lib_articl`
--
ALTER TABLE `lib_articl`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);
...
--
-- Индексы таблицы `lib_comm`
--
ALTER TABLE `lib_comm`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);
...
--
-- Индексы таблицы `loads_cat`
--
ALTER TABLE `loads_cat`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `loads_comm`
--
ALTER TABLE `loads_comm`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `loads_file`
--
ALTER TABLE `loads_file`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `loads_file_dop`
--
ALTER TABLE `loads_file_dop`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `loads_rating`
--
ALTER TABLE `loads_rating`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `loads_screen`
--
ALTER TABLE `loads_screen`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);
...
--
-- Индексы таблицы `photo_comm`
--
ALTER TABLE `photo_comm`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `photo_rating`
--
...
--
-- Индексы таблицы `presents_list`
--
ALTER TABLE `presents_list`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);
...
--
-- Индексы таблицы `smiles_cat`
--
ALTER TABLE `smiles_cat`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);
...
--
-- Индексы таблицы `status_comm`
--
ALTER TABLE `status_comm`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `status_rating`
--
ALTER TABLE `status_rating`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `touch_msg`
--
ALTER TABLE `touch_msg`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Индексы таблицы `touch_user`
--
ALTER TABLE `touch_user`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);
...
--
-- AUTO_INCREMENT для таблицы `albums_cat`
--
ALTER TABLE `albums_cat`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `albums_comm`
--
ALTER TABLE `albums_comm`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `albums_photos`
--
ALTER TABLE `albums_photos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `albums_rating`
--
ALTER TABLE `albums_rating`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `bann`
--
ALTER TABLE `bann`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `blacklist`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `blackusers`
--
ALTER TABLE `blackusers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `blog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `blog_comm`
--
ALTER TABLE `blog_comm`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `blog_rating`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `chat_msg`
--
ALTER TABLE `chat_msg`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT для таблицы `dey`
--
ALTER TABLE `dey`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `dialog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `dialog_msg`
--
ALTER TABLE `dialog_msg`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `files`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `files_comm`
--
ALTER TABLE `files_comm`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `files_file`
--
ALTER TABLE `files_file`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `forums`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `forums_cat`
--
ALTER TABLE `forums_cat`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `forums_new_post`
--
ALTER TABLE `forums_new_post`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `forums_post`
--
ALTER TABLE `forums_post`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `forums_theme`
--
ALTER TABLE `forums_theme`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `forums_vote`
--
ALTER TABLE `forums_vote`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `groups`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `groups_apps`
--
ALTER TABLE `groups_apps`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `groups_new_post`
--
ALTER TABLE `groups_new_post`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `groups_peoples`
--
ALTER TABLE `groups_peoples`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `groups_post`
--
ALTER TABLE `groups_post`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `groups_topic`
--
ALTER TABLE `groups_topic`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `groups_vote`
--
ALTER TABLE `groups_vote`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `guests`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `guest_comments`
--
ALTER TABLE `guest_comments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `guest_like`
--
ALTER TABLE `guest_like`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `guest_votes`
--
ALTER TABLE `guest_votes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `lenta`
--
ALTER TABLE `lenta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `lib`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `lib_articl`
--
ALTER TABLE `lib_articl`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `lib_cat`
--
ALTER TABLE `lib_cat`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `lib_comm`
--
ALTER TABLE `lib_comm`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `loads`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `loads_cat`
--
ALTER TABLE `loads_cat`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `loads_comm`
--
ALTER TABLE `loads_comm`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `loads_file`
--
ALTER TABLE `loads_file`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `loads_file_dop`
--
ALTER TABLE `loads_file_dop`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `loads_rating`
--
ALTER TABLE `loads_rating`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `loads_screen`
--
ALTER TABLE `loads_screen`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `news_comm`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `news_rating`
--
ALTER TABLE `news_rating`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `photo_comm`
--
ALTER TABLE `photo_comm`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `photo_rating`
--
ALTER TABLE `photo_rating`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `presents`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `presents_list`
--
ALTER TABLE `presents_list`
...
ALTER TABLE `smiles`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `smiles_cat`
--
ALTER TABLE `smiles_cat`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `status`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `status_comm`
--
ALTER TABLE `status_comm`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `status_rating`
--
ALTER TABLE `status_rating`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `touch_msg`
--
ALTER TABLE `touch_msg`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `touch_user`
--
ALTER TABLE `touch_user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
